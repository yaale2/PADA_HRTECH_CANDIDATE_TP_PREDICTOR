...
Гибридная нейросетевая система для оценки индивидуального риска досрочного увольнения кандидата. Использует исключительно данные резюме.
...
- Собирает публичные HTML-страницы резюме
